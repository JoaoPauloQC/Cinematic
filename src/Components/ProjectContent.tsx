...
export default function ProjectContent(){
    ...
    return (
        <div className=" border-2 rounded-xl px-3 py-2 Poppins flex gap-10 border-neutral-600 hover:bg-neutral-700 bg-neutral-900 ProjectBox">
            <div className="text py-10 px-3">
            <h1 className="text-4xl pb-10"> O que é Central Física? </h1>
            ...
            <p className="text-xl pt-10"> Se estiver interessado em me ajudar entre no <Link href={"https://github.com/JoaoPauloQC/Cinematic"} className="hover:text-blue-700 transition-colors duration-200 ease-in-out">Repositório Git do projeto</Link></p>
            <h1 className="text-3xl pt-10">Aproveite!</h1>
            </div>
            <div className="img w-96 h-96  object-cover rounded-xl">
