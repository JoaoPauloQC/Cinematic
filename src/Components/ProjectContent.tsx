...
export default function ProjectContent(){
    ...
    return (
        <div className=" border-2 rounded-xl px-3 py-2 Poppins flex gap-10 border-neutral-600 hover:bg-neutral-700 bg-neutral-900 ProjectBox max-md:flex-col">
            ...
            <p className="text-xl pt-10"> Se estiver interessado em me ajudar entre no <Link href={"https://github.com/JoaoPauloQC/Cinematic"} className="hover:text-blue-700 transition-colors duration-200 ease-in-out">Repositório Git </Link>do projeto</p>
